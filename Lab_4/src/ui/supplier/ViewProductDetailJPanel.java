...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product){
        ...
        if (product.getLogoPhoto() != null) {
            ImageIcon logoPhoto = product.getLogoPhoto();
            Image scaledImage = logoPhoto.getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH);
            imgPhoto.setIcon(new ImageIcon(scaledImage));
        } else {
            imgPhoto.setText("No Logo");
        }
